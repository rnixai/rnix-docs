...
本目录包含四篇实战教程，帮助你从零开始掌握 Rnix 的核心开发技能。
...
| 3 | [组合多智能体工作流](/zh/tutorials/composing-multi-agent-workflow) | 已完成教程 1 的开发者 | ~25 分钟 |
| 4 | [观察智能涌现](/zh/tutorials/observing-emergence) | 已完成教程 1 的开发者 | ~30 分钟 |

---

## 推荐学习路径

**新手路径：** 教程 1 → 教程 2 → 教程 3 → 教程 4（按顺序完成）

**有经验的开发者：** 可以直接跳到教程 3 学习多智能体编排，或教程 4 探索 Rnix 的智能涌现体系。
